```
└── 📁Django-social-platform-Connexa
        └── 📁hooks
        ...
        └── 📁objects
            └── 📁info
            └── 📁pack
                ├── pack-8e2d8a9339e6ece1a3ea7dd38d8337eab14a4924.idx
                ├── pack-8e2d8a9339e6ece1a3ea7dd38d8337eab14a4924.pack
                ├── pack-8e2d8a9339e6ece1a3ea7dd38d8337eab14a4924.rev
        └── 📁refs
            └── 📁heads
                ├── main
            └── 📁remotes
        ...
        └── 📁Lib
            └── 📁site-packages
                ...
                └── 📁channels_redis
                    ...
                    ├── serializers.py
                    ├── utils.py
                └── 📁channels_redis-4.2.1.dist-info
                    ├── INSTALLER
                    ├── LICENSE
                    ├── METADATA
                    ├── RECORD
                ...
                └── 📁redis
                    ...
                    └── 📁_parsers
                        └── 📁__pycache__
                            ...
                            ├── helpers.cpython-313.pyc
                            ├── hiredis.cpython-313.pyc
                            ├── resp2.cpython-313.pyc
                            ├── resp3.cpython-313.pyc
                    ...
                    └── 📁commands
                        ...
                        └── 📁search
                            └── 📁__pycache__
                                ...
                                ├── commands.cpython-313.pyc
                                ├── dialect.cpython-313.pyc
                                ├── document.cpython-313.pyc
                                ├── field.cpython-313.pyc
                                ├── index_definition.cpython-313.pyc
                                ├── profile_information.cpython-313.pyc
                                ├── query.cpython-313.pyc
                                ├── querystring.cpython-313.pyc
                                ├── reducers.cpython-313.pyc
                                ├── result.cpython-313.pyc
                                ├── suggestion.cpython-313.pyc
                            ├── __init__.py
                            ├── _util.py
                            ├── aggregation.py
                            ├── commands.py
    ...
    └── 📁bucosa
        └── 📁activities
            └── 📁migrations
                ├── __init__.py
                ├── 0001_initial.py
                ├── 0002_event_group_post_group.py
            └── 📁templates
                └── 📁activities
                    ├── add_comment.html
        ...
        └── 📁media
            └── 📁event_covers
                ...
                ├── Image_8_dWYoAcV.jpg
                ├── Image_8.jpg
                ├── Screenshot_20250302-065652.png
                ├── Screenshot_20250322-105144.png
                ├── Screenshot_20250514-193813_2xvWFka.png
                ├── Screenshot_20250514-193813.png
            └── 📁group_message_files
                ├── 3D_Bugema_logo.gif
                ├── Download_8_GUgqHTx.mp4
                ├── Download_8.mp4
            └── 📁group_pics
                ├── cc4d1d1ec11b16435ee71bbf7a349c42.jpg
                ├── dev.png
                ├── github-media.jpeg
            └── 📁images
                ├── default.jpg
            └── 📁post_images
                ├── 3D_Bugema_logo.gif
                ├── ccbf338419b9844933870a1c8d5aefd6.jpg
                ├── dev.png
                ├── Image_8.jpg
                ├── Screenshot_20250322-213358.png
            └── 📁post_videos
                ├── ad31ef23aecdd094a987a0fe286feb25.jpg
                ├── Download_14.mp4
                ├── Download_15_OuMLzYP.mp4
                ├── Download_15.mp4
                ├── Download_8_JYXgoPZ.mp4
                ├── Download_8.mp4
                ├── Image_8.jpg
            └── 📁private_message_images
                ├── Image_8.jpg
            └── 📁profile_pics
                ├── 3D_Bugema_logo.gif
                ├── 8a2d7852f75b9bb11094e9b36121f0c3.jpg
                ├── download_mZBaaax.png
                ├── download.png
                ├── Image_8.jpg
                ├── logo192.png
                ├── Screenshot_20250404-162843.png
                ├── volverin_Q9vg626.jpeg
                ├── volverin.jpeg
        └── 📁static
            └── 📁css
                ├── style.css
        ...
        └── 📁users
            └── 📁management
                └── 📁commands
                    ├── fix_legacy_group_creators.py
            └── 📁migrations
                ├── __init__.py
                ├── 0001_initial.py
                ├── 0002_remove_user_profile_is_private_and_more.py
                ├── 0003_user_profile_user.py
                ├── 0004_alter_user_profile_website.py
                ├── 0005_groupprofile.py
                ├── 0006_groupprofile_profile_image.py
                ├── 0007_groupmessage.py
                ├── 0008_groupmessage_file.py
                ├── 0009_groupmessage_pinned_groupmessagereaction.py
                ├── 0010_groupprofile_admins.py
                ├── 0011_privatemessage.py
                ├── 0012_alter_user_profile_user.py
            └── 📁templates
                └── 📁users
                    ├── analytics_dashboard.html
                    ├── create_group.html
                    ├── edit_group_message.html
                    ├── edit_group.html
                    ├── edit_profile.html
                    ├── group_chat.html
                    ├── group_list.html
            ...
            ├── apps.py
            ├── forms.py
            ├── models_group_message.py
            ├── models_group_reaction.py
            ├── models_private_message.py
            ├── models.py
            ├── tests.py
            ├── urls.py
            ├── views.py
